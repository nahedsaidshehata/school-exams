...
@section('page_title', __('Edit  School'))
@section('page_subtitle')
    {{ __('Update a school and its associated school account user.') }}
@endsection
    ...
    <div class="row g-3">
        <div class="col-12 col-lg-10 col-xl-8">
            <div class="card admin-card admin-form-card">
                ...
                <div class="card-body">
                    <form action="{{ route('admin.schools.update', $school->id) }}" method="POST" class="needs-validation"
                        novalidate>
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row g-3">
                            <div class="col-12 col-md-6">
                                ...
                                <input type="text" id="name_en" name="name_en" value="{{$school->name_en ?? ''}}"
                                    class="form-control @error('name_en') is-invalid @enderror" required autocomplete="off">
                                @error('name_en')
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <input type="text" id="name_ar" name="name_ar" value="{{ $school->name_ar ?? '' }}"
                                    class="form-control @error('name_ar') is-invalid @enderror" required autocomplete="off">
                                @error('name_ar')
                                <div class="invalid-feedback">{{ $message }}</div> @enderror
                            </div>
                        </div>
