...
@section('page_title', __('Create New School'))
@section('page_subtitle')
  {{ __('Create a school and its associated school account user.') }}
@endsection
  ...
  <div class="row g-3">
    <div class="col-12 col-lg-10 col-xl-8">
      <div class="card admin-card admin-form-card">
        ...
        <div class="card-body">
          <form action="{{ route('admin.schools.store') }}" method="POST" class="needs-validation" novalidate>
            @csrf
