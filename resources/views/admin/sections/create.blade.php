...
@section('page_title', __('Create New Section'))
@section('page_subtitle')
  {{ __('Add a new section under a subject.') }}
@endsection
  ...
  <div class="row g-3">
    <div class="col-12 col-lg-10 col-xl-8">
      <div class="card admin-card admin-form-card">
        ...
        <div class="card-body">
          <form action="{{ route('admin.sections.store') }}" method="POST" class="needs-validation" novalidate>
            @csrf
      ...
      <div class="text-muted small mt-3">
        {{ __('Tip: Keep section titles short and consistent across languages.') }}
      </div>
    </div>
  </div>
@endsection
